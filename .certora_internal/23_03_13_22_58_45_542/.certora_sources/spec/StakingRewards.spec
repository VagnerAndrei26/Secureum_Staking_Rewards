...
//Valid state
//If user has balance then he updated his rewards

invariant balanceToRewardState(address user)
    balanceOf(user) > 0 =>(userRewardPerTokenPaid(user) > 0 && rewards(user) > 0)
    // {
    //     preserved {
