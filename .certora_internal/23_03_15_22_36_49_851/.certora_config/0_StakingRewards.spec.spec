...
rule antiMonotonicity(address user) {
    ...
    mathint userStakingTokensBefore = stakingToken.balanceOf(user);
    mathint userRewardsBefore = rewards(user);
    mathint userRewardsTokensBefore = rewardsToken.balanceOf(user);
    f(e, args);
    mathint userBalanceAfter = balanceOf(user);
    mathint userStakingTokensAfter = stakingToken.balanceOf(user);
    mathint userRewardsAfter = rewards(user);
    mathint userRewardsTokensAfter = rewardsToken.balanceOf(user);
