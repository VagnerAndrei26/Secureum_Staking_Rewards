...
//More tokens staked - more rewards for the user
rule moreTokensStakedMoreRewards(env e, address user, address user2) {
    uint256 balanceOfUser1 = balanceOf(user);
    uint256 balanceOfUser2 = balanceOf(user2);

    uint256 rewardsUser1 = earned(e, user);
    uint256 rewardsUser2 = earned(e, user2);
 
    assert balanceOfUser1 > balanceOfUser2 => rewardsUser1 > rewardsUser2, "Less rewards for the user with greater balance";
}
