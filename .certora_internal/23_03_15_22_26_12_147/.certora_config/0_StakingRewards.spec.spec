...
rule antiMonotonicity(address user) {
    ...
    assert userBalanceAfter - userBalanceBefore == 
            ...
            "User must gain balance equivalent to staking tokens lost";
    assert userRewardsBefore - userRewardsAfter ==
            userRewardsTokensAfter - userRewardsTokensBefore,
            "User must get rewards token equivalent to rewards balance deducted";
}
